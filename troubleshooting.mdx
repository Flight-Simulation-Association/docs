...
1. Check the CRC logs for messages related to the STARS Keyboard. 
2. If you're using a USB hub, remove it and plug the keyboard directly into the computer.
3. Disable software that could potentially cause interference, such as keybinding utilities. 
4. Unplug and then replug in the device.
5. Restart CRC completely.
6. Restart your computer and then relaunch CRC. 
